...
$number = "";
$pno = "";
$sql = "select * from doctor where number = '$name'";
    ...
    <nav role="navigation" class="navbar navbar-default">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#myModal_signout" data-toggle="modal">Doctor</a></li>
            </ul>
        </div>
    </nav>
        ...
        <div class="col-sm-offset-3 col-md-6">
            <div class="color-palette-set">
                <div class="bg-aqua-active color-palette">
                    <div class="box-header with-border"><p><h2 style="color: white;">Doctor Dashboard</h2></p></div></div>
            </div></div>
        ...
        <div class="col-sm-offset-2 col-md-8">
            <div class="box box-primary box-solid collapsed-box">
                <div class="box-header with-border">
                    <h3 class="box-title">Your Patients</h3>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="example2" class="table table-bordered table-striped">
                                ...
                                <tbody>
                               <?php
                               $sql = "select * from Patient where doctor = '$name'";
                               $result=$conn->query($sql);
                               $modalid="";
                               if ($result->num_rows > 0) {
                                   // output data of each row
    ...
    <div class=\"modal-dialog modal-success\">
        ...
        <div class=\"modal-content\">
            ...
            <div class=\"modal-body\">
                <p> <form action=\"update.php\" method=\"post\" name=\"signup\" ><!-- specify the servelet file name in the action -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-header bg-aqua-active">
                            ...
                            <h5 class="widget-user-desc"><?php echo $dept;?></h5>
